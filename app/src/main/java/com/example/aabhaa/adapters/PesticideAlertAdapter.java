...
public class PesticideAlertAdapter extends RecyclerView.Adapter<PesticideAlertAdapter.AlertViewHolder> {
    ...
    public PesticideAlertAdapter(Context context, List<Content> alertList) {
